...
## Get All Clients
 ...
 response = HTTParty.get('https://api.jobhuk.com/partners/client_ids.json', headers: {"Token" => "API_TOKEN", "Accept" => "application/vnd.jobhuk.v1"})
 companies = response.body
 ```
 
 ```shell
 curl "https://api.jobhuk.com/partners/client-ids.json"\
   -H "Token: API_TOKEN"\  
   -H "Accept: application/vnd.jobhuk.v1"
 ```
 ...
 This endpoint retrieves list of client ids created by you.
 
### HTTP Request
 
`GET https://api.jobhuk.com/partners/client-ids.json`
...
`GET https://api.jobhuk.com/partners/companies?client_id=<client_id>`
...
--------- | ------  | -----------
user<br>required | hash | user fields hash
user[email]<br>required | string | user email address 
user[first_name]<br>required | string | user first name
user[last_name]<br>required | string | user last name
...
`GET https://api.jobhuk.com/partners/jobs/<job_id>.json?client_id=<client_id>`
...
`PUT https://api.jobhuk.com/partners/jobs/<job_id>.json?client_id=<client_id>`
...
`DELETE https://api.jobhuk.com/partners/jobs/<job_id>.json?client_id=<client_id>`
...
response = HTTParty.post("https://api.jobhuk.com/partners/jobs/1281/candidates?client_id=<client_id>", query: {candidate: {name: "john", email: "johnd@hatchforce.com", phone: 8558558359, public_profile_url: "https://www.linkedin.com/in/scottsantucci", :resume_file => File.new('/home/user/Downloads/josha_d.pdf')}},{headers:{"Token"=>"API_TOKEN"}})
candidate = response.body
```

```shell
 curl "https://api.jobhuk.com/partners/jobs/1281/candidates?client_id=<client_id>"\
   -X POST\ 
   -H "Token: API_TOKEN"\
   -H "Accept: application/vnd.jobhuk.v1"\
...
`POST https://api.jobhuk.com/partners/jobs/<job_id>/candidates?client_id=<client_id>`
...
```shell
curl https://api.jobhuk.com/partners/jobs/<job_id>/candidates?client_id=<client_id>\ 
  -H "Token:API_TOKEN"\
  -H "Accept: application/vnd.jobhuk.v1"
```
...
`GET https://api.jobhuk.com/partners/jobs/<job_id>/candidates?client_id=<client_id>`
...
response = HTTParty.get("https://api.jobhuk.com/partners/jobs/1281/candidates/3417?client_id=<client_id>", headers: {"Token" => "API_TOKEN", "Accept" => "application/vnd.jobhuk.v1"})
candidates = response.body
```

```shell
curl https://api.jobhuk.com/partners/jobs/<job_id>/candidates/<submission_id>?client_id=<client_id>\ 
  -H "Token:API_TOKEN"\
  -H "Accept: application/vnd.jobhuk.v1"
```
...
`GET https://api.jobhuk.com/partners/jobs/<job_id>/candidates/<submission_id>?client_id=<client_id>`
